        ...
        public function Verif()
	{
            if($_POST){
                ...
                if($det != false){
                    ...
                    $this->m_log->insert_log('Login','Sukses Login, Nama : '.php_uname('n').', IP '.$this->input->ip_address());
                    redirect('beranda');
                }else{
                    $this->m_log->insert_log('Login','Gagal Login, Nama : '.php_uname('n').', IP '.$this->input->ip_address());
