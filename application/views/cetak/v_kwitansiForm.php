...
<body>
    ...
    <form style="padding-left:13px; padding-top: 10px;" onsubmit="return validateForm()"  name="kwitansiForm" action="<?php echo site_url('cetak/kwitansi/'.$id) ?>" method="POST">
        <table style="border: 1px solid black;">
            ...
            <tr>
                ...
                <td>:</td>
                <td>Faktur tanggal <?php echo date("d-M-Y",strtotime($penjualanById->d.'-'.$penjualanById->m.'-'.$penjualanById->y));?> sebesar Rp. <?php 
