<?php
	...
	$mcImageManagerConfig['filesystem.path'] = '../../../../../../public/folder/tinymce-upload/'; // absolute or relative from this script path, optional.
	$mcImageManagerConfig['filesystem.rootpath'] = '../../../../../../public/folder/tinymce-upload/'; // absolute or relative from this script path, required.
